...
def FileGeneration(Xw, Xe, X, dxw, dxe, dx, CAP, CAW, CAE, CAC, CAQ, S, T, AT, ATO, CAPO):
    ...
    df['S'] = S
    df['T'] = T
    df.to_excel('CFD and Heat Transfer_1D Linear and Discontinuous and Steady.xlsx', index=True)
...
def main():
    ...
    Xw, Xe, X, dxw, dxe, dx, s, M, Af, kf, kp, Ap, Akeff, q, p_node = gridGeneration(L, M, d, A, K, Q, P)
